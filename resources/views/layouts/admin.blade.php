    ...
    <div class="left-section">
        ...
        <div class="content-nav mt-3" style="color: white;">
            ...
            @else
                ...
                <li class="nav-con"><i class="fa-solid fa-newspaper"></i><a href="{{ route('admin.pemberitahuan') }}"
                        class="ml-0.5">Pemberitahuan</a>
                </li>
                ...
                <li class="nav-con"><i class="fa-solid fa-tablet-screen-button"></i><a
    ...
    <div class="top-bar align-items-center px-2">
        ...
        <div class="d-flex w-50 justify-content-end">
            <p class="m-0 text-white"><i class="fa-solid fa-envelope pr-3"></i><i
                    class="fa-solid fa-grip-lines-vertical pr-3"></i>
                <a href="{{ route('admin.profil') }}" class="text-white">{{ Auth::user()->fullname }}</a><i
                    class="fa-solid fa-grip-lines-vertical px-3"></i><a href="{{ route('logout') }}"
                    class="text-white"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
            </p>
        </div>
    </div>
